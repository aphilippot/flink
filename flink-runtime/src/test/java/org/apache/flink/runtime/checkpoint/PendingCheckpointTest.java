...
public class PendingCheckpointTest {
	...
	public void testPersistExternally() throws Exception {
		...
		CheckpointProperties ephemeral = new CheckpointProperties(false, false, true, true, true, true, true, false);
	...
	public void testSetCanceller() {
		final CheckpointProperties props = new CheckpointProperties(false, false, true, true, true, true, true, false);
