...
public class CompletedCheckpointTest {
	...
	public void testCleanUpOnSubsume() throws Exception {
		...
		CheckpointProperties props = new CheckpointProperties(false, false, discardSubsumed, true, true, true, true, false);
	...
	public void testCleanUpOnShutdown() throws Exception {
		...
		for (JobStatus status : terminalStates) {
			...
			// Discard
			props = new CheckpointProperties(false, false, true, true, true, true, true, false);
